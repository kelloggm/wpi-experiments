...
/**
 * Creates a new instance of the customization based on the class name and the class loader in
 * effect by the cache.
 *
 * @author Jens Wilke
 */
public final class CustomizationSupplierByClassName<T>
   ...
   *
   * @param className Fully qualified class name, used to create the class instance via a {@link
   *     ClassLoader#loadClass(String)}. The class must have a default constructor. Not null.
   */
