...
/**
 * Combined interface for introspection and control functions of a cache relevant for management and
 * monitoring.
 *
 * @author Jens Wilke
 */
public interface CacheControl extends CacheOperation, CacheInfo {
  ...
  /**
   * Returns a snapshot of cache statistics if this cache supports statistics or {@code null}
   * otherwise.
   */
